...
CONFIG(debug,debug|release) {
unix:LIBS += -L../hid/debug -lhid -L../usbhid/debug -lusbhid -L../utility/debug -lutility -L$(EMCPATH)/lib -llinuxcnchal -llinuxcnc -lnml -llinuxcncini  -L../libusb-1.0.2/libusb/.libs -l:libusb-1.0.a  -ludev
} else {
unix:LIBS += -L../hid/release -lhid -L../usbhid/release -lusbhid -L../utility/release -lutility -L$(EMCPATH)/lib -llinuxcnchal -llinuxcnc -lnml -llinuxcncini  -L../libusb-1.0.2/libusb/.libs -l:libusb-1.0.a  -ludev
}
