...
CONFIG(debug,debug|release) {    
    LIBS += -L../hid/debug -lhid -L../usbhid/debug -lusbhid -L../utility/debug -lutility -L../libusb-1.0.2/libusb/.libs -l:libusb-1.0.a -L../qtcommon/debug -lqtcommon -ludev
} else {    
    LIBS += -L../hid/release -lhid -L../usbhid/release -lusbhid -L../utility/release -lutility -L../libusb-1.0.2/libusb/.libs -l:libusb-1.0.a -L../qtcommon/release -lqtcommon -ludev
}
